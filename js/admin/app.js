...
categoria.forEach((categoria) => {
  ...
  const $inputPublicada = document.getElementById('input-publicada');
    ...
    $form.addEventListener('submit', (event) => {
      ...
      if (estaEditando()) {
        editarPelicula(titulo, tipo, categoria, caratula, trailer, descripcion, publicada);
      } else {
        agregarPelicula(titulo, tipo, categoria, caratula, trailer, descripcion, publicada);
      }
